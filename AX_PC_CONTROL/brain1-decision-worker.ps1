...
while($true){
 @{protocol='AX PC1 BRAIN1 DECISION v2';nodeId='PC1';computerName=$env:COMPUTERNAME;status='ALIVE';heartbeatAt=[DateTime]::UtcNow.ToString('o')}|ConvertTo-Json|Set-Content (Join-Path $ev 'brain1-decision-heartbeat.json') -Encoding UTF8
