...
// Regression guard: browser JS strings inside webChatPage must use escaped newlines.
...
assert(source.includes("$('loginStatus').textContent='Connecting…'"), 'web chat login must show connecting state');
