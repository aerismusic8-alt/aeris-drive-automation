...
if ([string]::IsNullOrWhiteSpace($env:AX_PC1_EXECUTOR_COMMAND)) {
  $env:AX_PC1_EXECUTOR_COMMAND = "node `"$Specialist`""
}
...
Write-Output "AX PC1 Specialist bound: $env:AX_PC1_EXECUTOR_COMMAND"
